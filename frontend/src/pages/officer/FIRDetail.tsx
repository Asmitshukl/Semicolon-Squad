...
import { getFIR, MOCK_VOICE_GLOBAL } from '../../data/officerMock';
...
export const FIRDetail = () => {
  ...
  const voices = MOCK_VOICE_GLOBAL.filter((v) => v.firNo === fir.firNo);
  const voiceRows = voices.length ? voices : MOCK_VOICE_GLOBAL.slice(0, 2);
  ...
  return (
    <div>
      ...
      <FIRDetailView fir={fir} voices={voiceRows} />
