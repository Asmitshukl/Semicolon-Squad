export const AdminStationPage = () => (
  <div className="p-8 lg:p-10 max-w-[1400px]">
    ...
    <h1 className="text-3xl font-extrabold tracking-tight text-white mb-10">Police stations</h1>
    <hr className="border-0 h-px bg-white/[0.08] mb-6" />
    <p className="text-sm text-[#6B7280] font-mono">CCTNS sync — endpoint wiring pending. Use this view for layout QA.</p>
  </div>
);
