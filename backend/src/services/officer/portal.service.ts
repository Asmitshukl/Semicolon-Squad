...
import { FIRStatus, OfficerVerificationStatus, UrgencyLevel } from '../../generated/prisma/enums';
...
export class OfficerPortalService {
  ...
  static async listStationVoiceRecordings(officerUserId: string, firId?: string) {
    const profile = await this.getOfficerProfile(officerUserId);
